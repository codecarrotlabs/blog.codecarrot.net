...
image: //blog.codecarrot.net/images/0_zdzWJW4DiWkFjDnY.jpg
---
...
![urge to cry](//blog.codecarrot.net/images/0_2VBZNF_2sqpenWBm.gif)
...
![Ecma International Logo](//blog.codecarrot.net/images/0_Dz44AJquqzSujMVs.jpg)
...
![ECMA-262](//blog.codecarrot.net/images/1_eE4lFIIFfSsSiI-oEWuo5g.png)
...
![ECMA-260, ECMA-261, ECMA-262. There’s ECMAScript.](//blog.codecarrot.net/images/1_MebPqniAeJqU6_JdvkHwPQ.png)
...
![ECMAScript specification](//blog.codecarrot.net/images/0_QA6z7Rzw7HQ86C8A.png)
...
![An excerpt from the ECMAScript 2017 Language Specification. The document is only about 900 pages, if you are looking for a light read.](//blog.codecarrot.net/images/1_NbO9I9ukUcpW4IiH1d54gQ.png)
...
![Javascript](//blog.codecarrot.net/images/0_zdzWJW4DiWkFjDnY.jpg)
...
![A screenshot from September 3, 2017. It is a list of JavaScript’s experimental features that are not a part of ECMAScript (at least not yet).](//blog.codecarrot.net/images/1_YjTRv0-RFD7BeLwB6g8XuQ.png)
...
![A JavaScript engine](//blog.codecarrot.net/images/0_SHZfEJM35akWZuQH.jpg)
...
![This analogy helps to explain a few things about browsers](//blog.codecarrot.net/images/0_xEE0vGO6Wp0qIW5X.png)
...
![Different browser images](//blog.codecarrot.net/images/0_bk4ewUjYJ_nmt0y3.png)
...
![This table is part of a browser support table in the ECMAScript Wikipedia page. JavaScript versions are not mentioned here.](//blog.codecarrot.net/images/1_vmmMpbNmE2PgWYOg1KjPjA.png)
...
![In Firefox 50, pieces of ES2015 and ES2017 were both implemented in Firefox’s JavaScript engine, SpiderMonkey. Other pieces of ES2015 and ES2017 were implemented before, and will continue to be implemented in the future.](//blog.codecarrot.net/images/1_SIR7uB-QF30Vmham-qgI0g.png)
...
![Mario](//blog.codecarrot.net/images/0_rN9T3WXOJVCcTsbi_.jpg)
...
![ECMAScript 6](//blog.codecarrot.net/images/0_k4bggYx2QbIYZgl8.PNG)
...
![Babel](//blog.codecarrot.net/images/0_pX_GIONhqYIHp58u_.png)
