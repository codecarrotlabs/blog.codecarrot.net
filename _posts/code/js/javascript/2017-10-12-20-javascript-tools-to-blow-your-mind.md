...
image: http://blog.codecarrot.net/images/ZtBAmJoRqrJwzUuP6eYFsG-970-80.jpg
---
...
![Babel allows developers to write code using the latest version of JavaScript without sacrificing compatibility with older browsers](http://blog.codecarrot.net/images/babel-website-3453VSDerg34.png)
...
![JavaScript is among the fastest growing programming languages](http://blog.codecarrot.net/images/o3UDAeR3Din8AZ6dnqgjEk-650-80.jpg)
...
![Learn JavaScript for free and stay up to date with the latest news on JavaScript.com](http://blog.codecarrot.net/images/1-o9BJ_DkWpdASQV_A.png)
...
![Take advantage of immutability](http://blog.codecarrot.net/images/0-AjTy1nZrZsjB.png)
...
Since, by default, objects and arrays are not immutable in JavaScript, there is a library to help accomplish this. It’s called [Immutable.js](http://facebook.github.io/immutable-js/) and it was developed and open-sourced by an engineering team at Facebook.

## 09. Node.js: Avoid switching language context

![This platform for developing server-side web apps has opened up a world of new possibilities](http://blog.codecarrot.net/images/1-Azz7YwzYDKFj8iIGZg.png)
...
![This has grown into the world’s largest package manager](http://blog.codecarrot.net/images/1-DvIYrgwJ9EfAYv_nA.png)
...
![Angular: One framework to rule them all](http://blog.codecarrot.net/images/1-LbKGyab-9iR-rvnzPg.png)
...
![This JavaScript framework is maintained by a team at Google with the help of the open-source community, and the latest version makes it suitable for native mobile development](http://blog.codecarrot.net/images/1-Azz7YwzYYR6Fj8iIGZg.png)
...
![Opinionated framework Ember.js has the world’s cutest framework mascot: Tomster](http://blog.codecarrot.net/images/4f89-b0b4-ef7fce53f.png)
...
![A project by Facebook, Flow uses type inference to find bugs](http://blog.codecarrot.net/images/1-LbKGyabN69iR-rvnzPg.png)
