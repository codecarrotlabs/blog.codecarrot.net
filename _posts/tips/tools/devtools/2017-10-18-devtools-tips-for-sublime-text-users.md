...
![The Sources panel in Chrome DevTools can be used as a powerful editor and companion during debugging](//blog.codecarrot.net/images/1-RXuLuUJs_JxzA7U_vZgNqQ.png)
...
![Goto Anything](//blog.codecarrot.net/images/1-v595nTQXCOB_FOzmaYWtrg.gif)
...
![Goto Line in file](//blog.codecarrot.net/images/1-PBHOVst6HsDfLdfFU7QwDA.gif)
...
![Adding multiple Caret](//blog.codecarrot.net/images/1-4svsSOFNREo3PYlqAIHMcw.gif)
...
![Adding multiple Carets](//blog.codecarrot.net/images/1-zWyHDztwW8K6h6ocgo4RBQ.gif)
...
![Wrap with Quotes or Brackets](//blog.codecarrot.net/images/1-uFxPo9AInxze4-VAOQZ23w.gif)
...
![Carets and matching words](//blog.codecarrot.net/images/1-zsYjnj7I6Mi1WF1oy_lyYQ.gif)
...
![Jump to matching brackets](//blog.codecarrot.net/images/1-QdrkPBShYAHrDhr5UElG1A.gif)
...
![Indentation](//blog.codecarrot.net/images/1-_QkNVE12OJjcAs3ejnlVqw.gif)
...
![Quickly comment your code](//blog.codecarrot.net/images/1-zeNecjKCY0sSTVZ1ZFHaPw.gif)
...
![Toggle Autocompletion](//blog.codecarrot.net/images/1-LMoNl681Off06TxYdZcWiA.gif)
...
![Increment and Decrement values](//blog.codecarrot.net/images/1-el4vmdu2MAwwZw5o9pyG0w.gif)
...
![Increase and Decrease values](//blog.codecarrot.net/images/1-1UHsuMbrljOwdCrgQ84g6w.gif)
...
![Cycle through editing locations](//blog.codecarrot.net/images/1-ccH3zKqBHkwq445ijzSXsw.gif)
...
![Shortcuts page](//blog.codecarrot.net/images/1-ruU4iOfl63bDdOcHf0t6Hg.png)
...
![Source Settings](//blog.codecarrot.net/images/1-kNSTfEe7h8FJUgJ8eFd6bA.png)
...
![The ZeroDarkMatrix theme](//blog.codecarrot.net/images/1-0v6KQTbisUbn_kF9MFWRxw.png)
...
![Display values inline while you’re debugging (see the blocks highlighted in orange). Enabled via Settings > Sources > Display variable values inline while debugging](//blog.codecarrot.net/images/1-8eBfaiXNPUu8NK2qKspaLA.png)
