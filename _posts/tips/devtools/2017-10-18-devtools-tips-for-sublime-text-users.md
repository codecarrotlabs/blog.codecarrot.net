...
image: http://blog.codecarrot.net/images/1-RXuLuUJs_JxzA7U_vZgNqQ.png
---
...
*Let’s assume for the rest of this write-up that we’ll primarily be working inside the DevTools Sources panel — a feature which, when paired with [Workspaces](https://developer.chrome.com/devtools/docs/workspaces) gives you a powerful in-browser editor.*

![The Sources panel in Chrome DevTools can be used as a powerful editor and companion during debugging](http://blog.codecarrot.net/images/1-RXuLuUJs_JxzA7U_vZgNqQ.png)
...
![Goto Anything](http://blog.codecarrot.net/images/1-v595nTQXCOB_FOzmaYWtrg.gif)
...
![Goto Line in file](http://blog.codecarrot.net/images/1-PBHOVst6HsDfLdfFU7QwDA.gif)
...
![Adding multiple Caret](http://blog.codecarrot.net/images/1-4svsSOFNREo3PYlqAIHMcw.gif)
...
![Adding multiple Carets](http://blog.codecarrot.net/images/1-zWyHDztwW8K6h6ocgo4RBQ.gif)
...
![Wrap with Quotes or Brackets](http://blog.codecarrot.net/images/1-uFxPo9AInxze4-VAOQZ23w.gif)
...
![Carets and matching words](http://blog.codecarrot.net/images/1-zsYjnj7I6Mi1WF1oy_lyYQ.gif)
...
![Jump to matching brackets](http://blog.codecarrot.net/images/1-QdrkPBShYAHrDhr5UElG1A.gif)
...
![Indentation](http://blog.codecarrot.net/images/1-_QkNVE12OJjcAs3ejnlVqw.gif)
...
![Quickly comment your code](http://blog.codecarrot.net/images/1-zeNecjKCY0sSTVZ1ZFHaPw.gif)
...
![Toggle Autocompletion](http://blog.codecarrot.net/images/1-LMoNl681Off06TxYdZcWiA.gif)
...
![Increment and Decrement values](http://blog.codecarrot.net/images/1-el4vmdu2MAwwZw5o9pyG0w.gif)
...
![Increase and Decrease values](http://blog.codecarrot.net/images/1-1UHsuMbrljOwdCrgQ84g6w.gif)
...
![Cycle through editing locations](http://blog.codecarrot.net/images/1-ccH3zKqBHkwq445ijzSXsw.gif)

## Shortcuts page

If you’ve found the above shortcuts helpful, you can pull most of them up via the DevTools [settings menu](https://developer.chrome.com/devtools/docs/settings). It looks a little like this:

![Shortcuts page](http://blog.codecarrot.net/images/1-ruU4iOfl63bDdOcHf0t6Hg.png)
...
![Source Settings](http://blog.codecarrot.net/images/1-kNSTfEe7h8FJUgJ8eFd6bA.png)
...
* [https://github.com/mauricecruz/chrome-devtools-zerodarkmatrix-theme](https://github.com/mauricecruz/chrome-devtools-zerodarkmatrix-theme)
* [https://github.com/xero/greybeard-devtools](https://github.com/xero/greybeard-devtools)

![The ZeroDarkMatrix theme](http://blog.codecarrot.net/images/1-0v6KQTbisUbn_kF9MFWRxw.png)

*The ZeroDarkMatrix theme*

## To install a theme:

* Install it from the [Chrome Web Store](https://chrome.google.com/webstore/search/devtools?_category=extensions).
...
* Boom. You should be good to go. Themes can be found in a number of places, including the Web Store, [DevThemez.com](http://DevThemez.com) and GitHub.
...
![Display values inline while you’re debugging (see the blocks highlighted in orange). Enabled via Settings > Sources > Display variable values inline while debugging](http://blog.codecarrot.net/images/1-8eBfaiXNPUu8NK2qKspaLA.png)
...
If you’re hungry for more and want to continue improving your workflow, grab Wes’ [Sublime Text Book + Videos ](https://sublimetextbook.com/)— use the code **DEVTOOLS** for $11 off. You can also check-out the first episode of [Totally Tooling Tips](https://www.youtube.com/watch?v=2eu23_if6Lw&index=11&list=PLOU2XLYxmsILKwwASNS0xgfcmakbK_8JZ) for a look at Sublime Text plugins.

This blog is published at medium by [Addy Osmani](https://twitter.com/addyosmani).
