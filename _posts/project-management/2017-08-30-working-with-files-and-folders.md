...
![List of files and folder in atom text editor](files-and-folders-in-atom-text-editor.png)
...
![Files and folder](files-and-folders.jpg)
...
![Mac trash icon](mac-trash-icon.png)
...
![File Explorer in windows 8](file-explorer-in-windows-8.png)
...
![Mac finder icon](mac-finder-icon.png)
...
![Windows 8 Notepad](w8-notepad.png)
...
![Text editor Sublime Text](textedit-ss.png)
...
![Make plain Text File](make-plain-text.png)
